...
<html>
		...
		<div class="container">
			...
			<div class="panel-body">
				<h2 class="text-danger">
					<!-- 显示time图标 -->
					<span class="qlyphicon qlyphicon-time"></span>
					<!-- 展示倒计时 -->
					<span class="qlyphicon" id="seckill-box"></span>
				</h2>
			</div>
		</div>
	...
	<c:url var="url4" value="/resource/script/seckill.js" />
	...
	<script type="text/javascript">
		$(function(){
			...
			seckill.detail.init({
				...
				startTime : ${seckill.startTime.time}, //加.time是返回时间的毫秒的意思
