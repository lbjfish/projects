...
public class Account {
	...
	public void setRecommender_idcard_no(String recommender_idcard_no) {
		this.recommender_idcard_no = recommender_idcard_no;
	}
	...
	public Account(Integer account_id, Integer recommender_id,
			String login_name, String login_passwd, String status,
			Timestamp create_date, Timestamp pause_date, Timestamp close_date,
			String real_name, String idcard_no, Date birthdate, String gender,
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((recommender_id == null) ? 0 : recommender_id.hashCode());
	...
	public String toString(){
		return account_id+","+recommender_id+","+login_name+","+login_passwd+","+status+","+
		create_date+","+pause_date+","+close_date+","+real_name+","+idcard_no+","+birthdate+","+
