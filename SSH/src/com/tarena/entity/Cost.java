...
public class Cost {
	...
	public Cost(String name, Integer base_duration,
			Double base_cost, Double unit_cost, String status, String descr,
			Timestamp creatime, Timestamp startime, String cost_type) {
		super();
		this.name = name;
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((base_cost == null) ? 0 : base_cost.hashCode());
		result = prime * result
				+ ((base_duration == null) ? 0 : base_duration.hashCode());
		...
		result = prime * result
				+ ((unit_cost == null) ? 0 : unit_cost.hashCode());
		return result;
	}
	...
	public String toString(){
		return cost_id+","+name+","+base_duration+","+
